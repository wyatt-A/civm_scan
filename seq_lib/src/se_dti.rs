...
fn test(){
    ...
    me.ppl_export(Path::new(r"d:\dev\221028\se\sim"),"setup",true,true);
    ...
    mep.setup_mode = false;
    let mut me = SpinEchoDW::new(mep.clone());
    me.ppl_export(Path::new(r"d:\dev\221028\se\acquire"),"setup",false,true);
    ...
    mep.setup_mode = true;
    let mut me = SpinEchoDW::new(mep.clone());
    me.ppl_export(Path::new(r"d:\dev\221028\se\rf_power"),"setup",false,true);
    ...
    mep.n_repetitions = 2;
    let mut me = SpinEchoDW::new(mep.clone());
    me.ppl_export(Path::new(r"d:\dev\221028\se\se_timing"),"setup",false,true);
...
impl PulseSequence for SpinEchoDW {
    ...
    fn base_params(&self) -> PPLBaseParams {
        PPLBaseParams {
            ...
            base_frequency: BaseFrequency::civm9p4t(-806.0),
